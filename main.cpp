...
int main() 
{
	std::vector<std::string> studentIDNumbers = {
	...
	std::sort(studentIDNumbers.begin(), studentIDNumbers.end());

	std::for_each(studentIDNumbers.begin(), studentIDNumbers.end(), [](std::string& studentID) {
